...
void UBlasterAnimInstance::NativeUpdateAnimation(float DeltaTime)
{
    ...
    if (bWeaponEquipped && EquippedWeapon && EquippedWeapon->GetWeaponMesh() && BlasterCharacter->GetMesh())
    {
        ...
        //BlasterCharacter->GetSkeletalMesh()->TransformToBoneSpace(FName("hand_r"), LeftHandTransform.GetLocation(), FRotator::ZeroRotator, OutPosition, OutRotation);
        ...
        // DebugLines to check the difference between gun and crosshair position
    ...
    bTransformingRightHand = BlasterCharacter->GetCombatState() == ECombatState::ECS_Unoccupied && !BlasterCharacter->GetDisableGameplay();
}